...
/************************************************************************
 *  Compilation:  javac InsertStudents.java
 *  Execution:    java InsertStudents
 *
 *  Example of developing an JDBC program to query DB
 *
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            stmt.executeUpdate("insert into Students "
                    + "values('John-Mark', 00101, 3.99, 2006, 3)");
            stmt.executeUpdate("insert into Students "
                    + "values('Chung-Wei', 00049, 3.65, 2005, 2)");
            stmt.executeUpdate("insert into Students "
                    + "values('Karazim', 00150, 2.89, 2006, 3)");
            stmt.executeUpdate("insert into Students "
                    + "values('Ramirez', 00101, 2.09, 2006, 1)");
            stmt.executeUpdate("insert into Students "
                    + "values('Francis', 00125, 2.99, 2006, 3)");
